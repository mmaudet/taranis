"""Prépare le dataset SYNOP full avec **vraies étiquettes d'orage**.

Étape 10. Les étiquettes ne viennent plus de `rr1 > 2 mm` mais du code
**temps présent WMO 4677** rapporté par l'observateur, donc :

- Codes **17, 29, 91-99** : orage observé au sens strict.
- Fenêtre `storm_active` étendue de ±1 pas SYNOP (±3 h) pour capter la durée
  typique de l'événement.

Sortie : `data/real_full_ww_windows.npz`. Canaux enrichis (5), identiques à
l'étape 9, seule l'étiquette change.
"""
